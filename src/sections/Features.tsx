        ...
        <SectionBorder borderTop>
          <SectionContent className="md:px-20 lg:px-40">
            ...
            <div className="size-[270px] md:size-[450px] relative flex flex-shrink-0">
              ...
              key={alt}
              >
                <motion.div className="inline-flex  size-10 md:size-14 items-center justify-center border border-[var(--color-border)]
                 rounded-lg absolute left-0 top-1/2 -translate-x-1/2 -translate-1/2 -rotate-0 bg-gray-950" 
                 initial={{
                  translate: `-50%, -50%`,
                  rotate: -rotate,
                 }}
                ...
                transition={{
                 ...
                 style={{
                  transform: `transform(-50%, -50%) rotate(-${rotate}deg)`,
                 }}>
