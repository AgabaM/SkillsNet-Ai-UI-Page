...
const useMousePosition = () => {
  ...
  const xProgress = useTransform(clientX, [0, innerWidth],
    [0, 1]
  );
  const yProgress = useTransform(clientY, [0, innerHeight],
    [0, 1]
  );
   ...
   <section id="Hero" ref={sectionRef}>
    <div className="container">
     ...
     <p className='text-center text-xl md:text-xl lg:text-2xl mt-8 md:mx-16 lg:mx-40'>
      Harness the power of AI with SkillsNet. Elevate your productivity and
       streamline your workflow with our cutting-edge AI Chat 
     </p>
     ...
     <Button variants="secondary" className='mt-10'>
      ...
      size="md"
      color="fuchsia" 
      className='-translate-x-[450px] -translate-y-[76px] rotate-135'
      />
      </motion.div>
      ...
      size="lg"
      color="teal" 
      className='-translate-x-[200px] -translate-y-[96px] rotate-135'
      />
      ...
      size="lg"
      color="violet" 
      className='-translate-x-[-270px] -translate-y-[150px] -rotate-135'
      />
         </motion.div>
    ...
    <motion.div style={{
      ...
      size="sm"
      color="yellow" 
      className='-translate-y-[500px] -translate-x-[430px] rotate-135'
      />
      </motion.div>
      ...
      size="sm"
      color="fuchsia" 
      className='translate-x-[150px] -translate-y-[600px] rotate-180'
      />
      </motion.div>
     ...
     <Planet 
      size="sm"
      color="yellow" 
      className='translate-x-[380px] -translate-y-[640px] -rotate-135'
      />
      </motion.div>
        ...
        <div className='absolute top-0 left-0 z-10 top-[30%] -translate-x-10 hidden lg:block'>
          ...
          style={{
            ...
            <div>Can you generate an incridible frontend dev video tutorial?</div>
        ...
        <div className='absolute top-0 right-0 z-10 top-[50%] translate-x-10 hidden lg:block'>
          ...
          style={{
            ...
            <div><strong>Brainwave:</strong> I created one based on videos from Mosh Labs!</div>
        ...
        <div className='absolute bottom-2 md:bottom-4 lg:bottom-10 left-1/2 -translate-x-1/2 w-full max-w-xs sm-mx-2 px-4'>
          <div className='bg-gray-950/80 flex items-center gap-4 px-4 py-2 rounded-2xl w-[320px] max-w-full'>
            ...
            <div className='font-semibold text-xl text-gray-100'>
               Ai is generating 
               <span className='animate-cursor-blink'></span></div>
          </div>
        </div>
        </div>
      </div>
